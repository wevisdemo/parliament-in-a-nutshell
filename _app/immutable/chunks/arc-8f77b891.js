import{S as Tt,i as Rt,s as St,K as pt,r as kt,L as dt,n as xt,u as Ct,h as at,p as Pt,b as qt,J as mt,E as st,o as zt,R as Et}from"./index-8a378d88.js";import{S as gt,r as It,a as Q}from"./transform-6b7f2bd3.js";function Lt(t){return typeof t=="string"?new gt([[document.querySelector(t)]],[document.documentElement]):new gt([[t]],It)}const ot=Math.PI,lt=2*ot,B=1e-6,Ft=lt-B;function ut(){this._x0=this._y0=this._x1=this._y1=null,this._=""}function ct(){return new ut}ut.prototype=ct.prototype={constructor:ut,moveTo:function(t,n){this._+="M"+(this._x0=this._x1=+t)+","+(this._y0=this._y1=+n)},closePath:function(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._+="Z")},lineTo:function(t,n){this._+="L"+(this._x1=+t)+","+(this._y1=+n)},quadraticCurveTo:function(t,n,e,l){this._+="Q"+ +t+","+ +n+","+(this._x1=+e)+","+(this._y1=+l)},bezierCurveTo:function(t,n,e,l,s,o){this._+="C"+ +t+","+ +n+","+ +e+","+ +l+","+(this._x1=+s)+","+(this._y1=+o)},arcTo:function(t,n,e,l,s){t=+t,n=+n,e=+e,l=+l,s=+s;var o=this._x1,g=this._y1,r=e-t,u=l-n,a=o-t,y=g-n,c=a*a+y*y;if(s<0)throw new Error("negative radius: "+s);if(this._x1===null)this._+="M"+(this._x1=t)+","+(this._y1=n);else if(c>B)if(!(Math.abs(y*r-u*a)>B)||!s)this._+="L"+(this._x1=t)+","+(this._y1=n);else{var i=e-o,m=l-g,_=r*r+u*u,T=i*i+m*m,d=Math.sqrt(_),h=Math.sqrt(c),x=s*Math.tan((ot-Math.acos((_+c-T)/(2*d*h)))/2),v=x/h,M=x/d;Math.abs(v-1)>B&&(this._+="L"+(t+v*a)+","+(n+v*y)),this._+="A"+s+","+s+",0,0,"+ +(y*i>a*m)+","+(this._x1=t+M*r)+","+(this._y1=n+M*u)}},arc:function(t,n,e,l,s,o){t=+t,n=+n,e=+e,o=!!o;var g=e*Math.cos(l),r=e*Math.sin(l),u=t+g,a=n+r,y=1^o,c=o?l-s:s-l;if(e<0)throw new Error("negative radius: "+e);this._x1===null?this._+="M"+u+","+a:(Math.abs(this._x1-u)>B||Math.abs(this._y1-a)>B)&&(this._+="L"+u+","+a),e&&(c<0&&(c=c%lt+lt),c>Ft?this._+="A"+e+","+e+",0,1,"+y+","+(t-g)+","+(n-r)+"A"+e+","+e+",0,1,"+y+","+(this._x1=u)+","+(this._y1=a):c>B&&(this._+="A"+e+","+e+",0,"+ +(c>=ot)+","+y+","+(this._x1=t+e*Math.cos(s))+","+(this._y1=n+e*Math.sin(s))))},rect:function(t,n,e,l){this._+="M"+(this._x0=this._x1=+t)+","+(this._y0=this._y1=+n)+"h"+ +e+"v"+ +l+"h"+-e+"Z"},toString:function(){return this._}};function S(t){return function(){return t}}const yt=Math.abs,A=Math.atan2,U=Math.cos,Ot=Math.max,rt=Math.min,q=Math.sin,E=Math.sqrt,b=1e-12,H=Math.PI,V=H/2,bt=2*H;function $t(t){return t>1?0:t<-1?H:Math.acos(t)}function _t(t){return t>=1?V:t<=-1?-V:Math.asin(t)}function Ut(t){return t.innerRadius}function Bt(t){return t.outerRadius}function Kt(t){return t.startAngle}function Dt(t){return t.endAngle}function Ht(t){return t&&t.padAngle}function Nt(t,n,e,l,s,o,g,r){var u=e-t,a=l-n,y=g-s,c=r-o,i=c*u-y*a;if(!(i*i<b))return i=(y*(n-o)-c*(t-s))/i,[t+i*u,n+i*a]}function G(t,n,e,l,s,o,g){var r=t-e,u=n-l,a=(g?o:-o)/E(r*r+u*u),y=a*u,c=-a*r,i=t+y,m=n+c,_=e+y,T=l+c,d=(i+_)/2,h=(m+T)/2,x=_-i,v=T-m,M=x*x+v*v,I=s-o,P=i*T-_*m,L=(v<0?-1:1)*E(Ot(0,I*I*M-P*P)),F=(P*v-x*L)/M,R=(-P*x-v*L)/M,k=(P*v+x*L)/M,C=(-P*x+v*L)/M,f=F-d,p=R-h,O=k-d,$=C-h;return f*f+p*p>O*O+$*$&&(F=k,R=C),{cx:F,cy:R,x01:-y,y01:-c,x11:F*(s/I-1),y11:R*(s/I-1)}}function Zt(){var t=Ut,n=Bt,e=S(0),l=null,s=Kt,o=Dt,g=Ht,r=null;function u(){var a,y,c=+t.apply(this,arguments),i=+n.apply(this,arguments),m=s.apply(this,arguments)-V,_=o.apply(this,arguments)-V,T=yt(_-m),d=_>m;if(r||(r=a=ct()),i<c&&(y=i,i=c,c=y),!(i>b))r.moveTo(0,0);else if(T>bt-b)r.moveTo(i*U(m),i*q(m)),r.arc(0,0,i,m,_,!d),c>b&&(r.moveTo(c*U(_),c*q(_)),r.arc(0,0,c,_,m,d));else{var h=m,x=_,v=m,M=_,I=T,P=T,L=g.apply(this,arguments)/2,F=L>b&&(l?+l.apply(this,arguments):E(c*c+i*i)),R=rt(yt(i-c)/2,+e.apply(this,arguments)),k=R,C=R,f,p;if(F>b){var O=_t(F/c*q(L)),$=_t(F/i*q(L));(I-=O*2)>b?(O*=d?1:-1,v+=O,M-=O):(I=0,v=M=(m+_)/2),(P-=$*2)>b?($*=d?1:-1,h+=$,x-=$):(P=0,h=x=(m+_)/2)}var K=i*U(h),D=i*q(h),N=c*U(M),Z=c*q(M);if(R>b){var j=i*U(x),J=i*q(x),W=c*U(v),X=c*q(v),z;if(T<H&&(z=Nt(K,D,W,X,j,J,N,Z))){var Y=K-z[0],tt=D-z[1],nt=j-z[0],et=J-z[1],ft=1/q($t((Y*nt+tt*et)/(E(Y*Y+tt*tt)*E(nt*nt+et*et)))/2),ht=E(z[0]*z[0]+z[1]*z[1]);k=rt(R,(c-ht)/(ft-1)),C=rt(R,(i-ht)/(ft+1))}}P>b?C>b?(f=G(W,X,K,D,i,C,d),p=G(j,J,N,Z,i,C,d),r.moveTo(f.cx+f.x01,f.cy+f.y01),C<R?r.arc(f.cx,f.cy,C,A(f.y01,f.x01),A(p.y01,p.x01),!d):(r.arc(f.cx,f.cy,C,A(f.y01,f.x01),A(f.y11,f.x11),!d),r.arc(0,0,i,A(f.cy+f.y11,f.cx+f.x11),A(p.cy+p.y11,p.cx+p.x11),!d),r.arc(p.cx,p.cy,C,A(p.y11,p.x11),A(p.y01,p.x01),!d))):(r.moveTo(K,D),r.arc(0,0,i,h,x,!d)):r.moveTo(K,D),!(c>b)||!(I>b)?r.lineTo(N,Z):k>b?(f=G(N,Z,j,J,c,-k,d),p=G(K,D,W,X,c,-k,d),r.lineTo(f.cx+f.x01,f.cy+f.y01),k<R?r.arc(f.cx,f.cy,k,A(f.y01,f.x01),A(p.y01,p.x01),!d):(r.arc(f.cx,f.cy,k,A(f.y01,f.x01),A(f.y11,f.x11),!d),r.arc(0,0,c,A(f.cy+f.y11,f.cx+f.x11),A(p.cy+p.y11,p.cx+p.x11),d),r.arc(p.cx,p.cy,k,A(p.y11,p.x11),A(p.y01,p.x01),!d))):r.arc(0,0,c,M,v,d)}if(r.closePath(),a)return r=null,a+""||null}return u.centroid=function(){var a=(+t.apply(this,arguments)+ +n.apply(this,arguments))/2,y=(+s.apply(this,arguments)+ +o.apply(this,arguments))/2-H/2;return[U(y)*a,q(y)*a]},u.innerRadius=function(a){return arguments.length?(t=typeof a=="function"?a:S(+a),u):t},u.outerRadius=function(a){return arguments.length?(n=typeof a=="function"?a:S(+a),u):n},u.cornerRadius=function(a){return arguments.length?(e=typeof a=="function"?a:S(+a),u):e},u.padRadius=function(a){return arguments.length?(l=a==null?null:typeof a=="function"?a:S(+a),u):l},u.startAngle=function(a){return arguments.length?(s=typeof a=="function"?a:S(+a),u):s},u.endAngle=function(a){return arguments.length?(o=typeof a=="function"?a:S(+a),u):o},u.padAngle=function(a){return arguments.length?(g=typeof a=="function"?a:S(+a),u):g},u.context=function(a){return arguments.length?(r=a==null?null:a,u):r},u}const jt={draw(t,n){const e=E(n/H);t.moveTo(e,0),t.arc(0,0,e,0,bt)}},it=E(3),vt={draw(t,n){const e=-E(n/(it*3));t.moveTo(0,e*2),t.lineTo(-it*e,-e),t.lineTo(it*e,-e),t.closePath()}};function At(t,n){let e=null;t=typeof t=="function"?t:S(t||jt),n=typeof n=="function"?n:S(n===void 0?64:+n);function l(){let s;if(e||(e=s=ct()),t.apply(this,arguments).draw(e,+n.apply(this,arguments)),s)return e=null,s+""||null}return l.type=function(s){return arguments.length?(t=typeof s=="function"?s:S(s),l):t},l.size=function(s){return arguments.length?(n=typeof s=="function"?s:S(+s),l):n},l.context=function(s){return arguments.length?(e=s==null?null:s,l):e},l}function Jt(t){let n,e,l;return{c(){n=pt("svg"),e=pt("style"),l=kt(`.total-text {
